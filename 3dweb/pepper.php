    ...
    <div class="container my-5">
        ...
        <div id="model_container" style="width: 100%; height: 400px;">
            <x3d id="model_x3d" width="100%" height="100%">
                <scene>
                    <inline  nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="models/pepper.x3d"></inline>
                </scene>
            </x3d>
        </div>
        ...
        <div class="row mt-3 justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <!-- Pepper Text -->
                <h1>Dr Pepper</h1>
                <p>Dr Pepper is a unique and bold soda that's been satisfying taste buds for over 130 years. Available in cans or cups, its 23 flavors come together to create a one-of-a-kind taste that's as delicious as it is distinctive.</p>
                <!-- botton -->
                <div class="card">
                    <div class="card-body">
                        <div id="playSpin">
     ...
     <div class="container my-5">
            <div class="row">
                <div class="col-md-12 text-center">
                    <img src="models/pepper-gallery.png" alt="Coca-Cola Gallery" class="img-fluid cursor-pointer" data-toggle="modal" data-target="#galleryModal">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="models/pepper-gallery.png" alt="Coca-Cola Gallery" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
