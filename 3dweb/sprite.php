    ...
    <div class="container my-5">
        ...
        <div id="model_container" style="width: 100%; height: 400px;">
            <x3d id="model_x3d" width="100%" height="100%">
                <scene>
                    <inline  nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="models/sprite.x3d"></inline>
                </scene>
            </x3d>
        </div>
        ...
        <div class="row mt-3 justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <!-- Sprite Text -->
                <h1>Sprite</h1>
                <p>Sprite is a crisp and refreshing lemon-lime soda that is perfect for any occasion. Available in bottles or cans, it's the perfect way to quench your thirst with its clean, crisp, and refreshing taste.</p>
                <!-- Botton -->
                <div class="card">
                    <div class="card-body">
                        <div id="playSpin">
     ...
     <div class="container my-5">
            <div class="row">
                <div class="col-md-12 text-center">
                    <img src="models/sprite-gallery.png" alt="Coca-Cola Gallery" class="img-fluid cursor-pointer" data-toggle="modal" data-target="#galleryModal">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="models/sprite-gallery.png" alt="Coca-Cola Gallery" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
